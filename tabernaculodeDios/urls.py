...
urlpatterns = patterns('',
                       ...
                       url(r'(?P<mensaje>[2]+)^$', 'iglesia.views.login', name='login'),
                       ...
                       url(r'^buscarubigeopornombre', 'iglesia.views.buscarubigeopornombre',
                           name='buscarUbigeoPorNombre'),
                       url(r'^usuario/detalleusuario', 'iglesia.views.detalleusuario', name='detalleusuario'),
                       url(r'^usuario/detalleusuario(?P<id>\d+)/$', 'iglesia.views.detalleusuario',
                           name='detalleusuario'),
